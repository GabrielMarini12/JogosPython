...
def jogar():
    ...
    #função para gerar números aleatórios inteiros
    ...
    for rodada in range(1, total_de_tentativas + 1):
        ...
        #input devolve o valor digitado pelo usuário
...
#verificando se é o progarama principal rodando, se for, vai executar direto o programa de adivinhação (principal)
